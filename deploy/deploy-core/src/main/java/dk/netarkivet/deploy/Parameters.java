...
public class Parameters {
    ...
    public Parameters(XmlStructure root) throws ArgumentNotValid {
        ...
        machineUserName = root.getChild(Constants.DEPLOY_MACHINE_USER_NAME);
    ...
    public void newParameters(Element root) throws ArgumentNotValid {
        ...
        if (tmp.size() > 0) {
            ...
            if (tmp.size() > 1) {
                System.out.println("Maximum 1 value expected at: " + Constants.DEPLOY_INSTALL_DIR + " but "
                        + tmp.size() + " received.");
            }
        }
        ...
        if (tmp.size() > 0) {
            ...
            if (tmp.size() > 1) {
                System.out.println("Maximum 1 value expected at: " + Constants.DEPLOY_MACHINE_USER_NAME + " but "
                        + tmp.size() + " received.");
            }
        }
        ...
        if (tmp.size() > 0) {
            ...
            if (tmp.size() > 1) {
                System.out.println("Maximum 1 value expected at: " + Constants.DEPLOY_HARVEST_DATABASE_DIR + " but "
                        + tmp.size() + " received.");
            }
        }
        ...
        if (tmp.size() > 0) {
            ...
            // log if more than one database directory.
            if (tmp.size() > 1) {
                System.out.println("Maximum 1 value expected at: " + Constants.DEPLOY_ARCHIVE_DATABASE_DIR + " but "
                        + tmp.size() + " received.");
            }
        }
    }
