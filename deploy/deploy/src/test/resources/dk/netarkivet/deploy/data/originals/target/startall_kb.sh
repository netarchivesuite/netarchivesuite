...
ssh $1@kb-dev-adm-001.kb.dk ". /etc/profile; /home/test/UNITTEST/conf/startall.sh; sleep 5; cat /home/test/UNITTEST/*.log"
echo --------------------------------------------
echo --------------------------------------------
...
ssh $1@kb-dev-har-001.kb.dk ". /etc/profile; /home/test/UNITTEST/conf/startall.sh; sleep 5; cat /home/test/UNITTEST/*.log"
echo --------------------------------------------
echo --------------------------------------------
echo starting at:$1@kb-dev-har-002.kb.dk
ssh $1@kb-dev-har-002.kb.dk ". /etc/profile; /home/test/UNITTEST/conf/startall.sh; sleep 5; cat /home/test/UNITTEST/*.log"
echo --------------------------------------------
echo --------------------------------------------
echo starting at:$1@kb-dev-acs-001.kb.dk
ssh $1@kb-dev-acs-001.kb.dk ". /etc/profile; /home/test/UNITTEST/conf/startall.sh; sleep 5; cat /home/test/UNITTEST/*.log"
echo --------------------------------------------
