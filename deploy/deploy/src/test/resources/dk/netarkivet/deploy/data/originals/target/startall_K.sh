...
sleep 5
ssh ba-test@kb-test-bar-010.bitarkiv.kb.dk "more TEST\start_BitarchiveApplication.log" 
echo --------------------------------------------
...
sleep 5
ssh ba-test@kb-test-bar-011.bitarkiv.kb.dk "more TEST\start_BitarchiveApplication.log" 
echo --------------------------------------------
