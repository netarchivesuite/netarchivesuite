...
scp $1 $2@kb-dev-adm-001.kb.dk:/home/test
echo unzipping $1 at:kb-dev-adm-001.kb.dk
ssh $2@kb-dev-adm-001.kb.dk unzip -q -o /home/test/$1 -d /home/test/UNITTEST
echo copying settings and scripts
scp -r kb-dev-adm-001.kb.dk/* $2@kb-dev-adm-001.kb.dk:/home/test/UNITTEST/conf/
echo make scripts executable
ssh  $2@kb-dev-adm-001.kb.dk "chmod +x /home/test/UNITTEST/conf/*.sh "
echo make password files readonly
ssh $2@kb-dev-adm-001.kb.dk "chmod 400 /home/test/UNITTEST/conf//jmxremote.password"
echo --------------------------------------------
...
scp $1 $2@kb-dev-har-001.kb.dk:/home/test
echo unzipping $1 at:kb-dev-har-001.kb.dk
ssh $2@kb-dev-har-001.kb.dk unzip -q -o /home/test/$1 -d /home/test/UNITTEST
echo copying settings and scripts
scp -r kb-dev-har-001.kb.dk/* $2@kb-dev-har-001.kb.dk:/home/test/UNITTEST/conf/
echo make scripts executable
ssh  $2@kb-dev-har-001.kb.dk "chmod +x /home/test/UNITTEST/conf/*.sh "
echo make password files readonly
ssh $2@kb-dev-har-001.kb.dk "chmod 400 /home/test/UNITTEST/conf//jmxremote.password"
echo --------------------------------------------
echo INSTALLING TO:kb-dev-har-002.kb.dk
echo copying $1 to:kb-dev-har-002.kb.dk
scp $1 $2@kb-dev-har-002.kb.dk:/home/test
echo unzipping $1 at:kb-dev-har-002.kb.dk
ssh $2@kb-dev-har-002.kb.dk unzip -q -o /home/test/$1 -d /home/test/UNITTEST
echo copying settings and scripts
scp -r kb-dev-har-002.kb.dk/* $2@kb-dev-har-002.kb.dk:/home/test/UNITTEST/conf/
echo make scripts executable
ssh  $2@kb-dev-har-002.kb.dk "chmod +x /home/test/UNITTEST/conf/*.sh "
echo make password files readonly
ssh $2@kb-dev-har-002.kb.dk "chmod 400 /home/test/UNITTEST/conf//jmxremote.password"
echo --------------------------------------------
echo INSTALLING TO:kb-dev-acs-001.kb.dk
echo copying $1 to:kb-dev-acs-001.kb.dk
scp $1 $2@kb-dev-acs-001.kb.dk:/home/test
echo unzipping $1 at:kb-dev-acs-001.kb.dk
ssh $2@kb-dev-acs-001.kb.dk unzip -q -o /home/test/$1 -d /home/test/UNITTEST
echo copying settings and scripts
scp -r kb-dev-acs-001.kb.dk/* $2@kb-dev-acs-001.kb.dk:/home/test/UNITTEST/conf/
echo make scripts executable
ssh  $2@kb-dev-acs-001.kb.dk "chmod +x /home/test/UNITTEST/conf/*.sh "
echo make password files readonly
ssh $2@kb-dev-acs-001.kb.dk "chmod 400 /home/test/UNITTEST/conf//jmxremote.password"
echo --------------------------------------------
