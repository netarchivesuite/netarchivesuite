...
ssh $1@kb-dev-adm-001.kb.dk ". /etc/profile; /home/test/UNITTEST/conf/killall.sh"
echo --------------------------------------------
echo --------------------------------------------
...
ssh $1@kb-dev-har-001.kb.dk ". /etc/profile; /home/test/UNITTEST/conf/killall.sh"
echo --------------------------------------------
echo --------------------------------------------
echo kill at $1@kb-dev-har-002.kb.dk
ssh $1@kb-dev-har-002.kb.dk ". /etc/profile; /home/test/UNITTEST/conf/killall.sh"
echo --------------------------------------------
echo --------------------------------------------
echo kill at $1@kb-dev-acs-001.kb.dk
ssh $1@kb-dev-acs-001.kb.dk ". /etc/profile; /home/test/UNITTEST/conf/killall.sh"
echo --------------------------------------------
