...
public interface DeduplicateToCDXAdapterInterface {
     ...
     * input String is not a crawl-log duplicate line, null is returned.
     * 
     * @param line
     *            a line from a crawl log
     ...
     * deduplicate information to cdx records which it outputs to an output
     * stream.
     * 
     * @param is
     *            the input stream
