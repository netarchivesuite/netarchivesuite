...
public class DeduplicationCDXExtractionBatchJob extends ArchiveBatchJob {
    ...
    /**
     * A utility which has methods for converting a deduplicate crawl-log entry
     * to a CDX entry.
     */
    ...
    /**
     * A Pattern representing a compiled expression representing the url in a
     * metadata arcfile of a crawl log entry.
     */
    ...
    /**
     * If the ArchiveRecord is a crawl-log entry then any duplicate entries in
     * the crawl log are converted to CDX entries and written to the output.
     * Otherwise this method returns without doing anything. If the
     * ArchiveRecord is a WarcRecord, and the record is the warcinfo, the record
     * is skipped.
     * 
     * @param record
     *            The ArchiveRecord to be processed
     * @param os
