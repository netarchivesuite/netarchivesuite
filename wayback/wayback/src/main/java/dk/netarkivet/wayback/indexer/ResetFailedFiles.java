...
public class ResetFailedFiles {
    ...
    /**
     * Usage: java -cp dk.netarkivet.wayback.jar -Ddk.netarkivet.settings.file=/home
     * /test/TEST12/conf/settings_WaybackIndexerApplication.xml -Dsettings.common.applicationInstanceId=RESET_FILES
