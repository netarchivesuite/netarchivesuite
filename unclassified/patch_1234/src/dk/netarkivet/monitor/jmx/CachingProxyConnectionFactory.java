...
public class CachingProxyConnectionFactory implements
     ...
     * That is, all information used as arguments for the
    ...
    /**
     * If (server,port,userName) has been seen before,
     * looks up the cached connection associated with these values.
     * Otherwise passes the request on the the wrapped factory,
     * caching the result for future reuse.
     * @see JMXProxyConnectionFactory#getConnection(String, int, int,
     * String, String)
     */
