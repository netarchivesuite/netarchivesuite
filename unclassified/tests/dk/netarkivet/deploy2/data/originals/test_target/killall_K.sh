...
ssh ba-test@kb-test-bar-010.bitarkiv.kb.dk "cmd /c  c:\Documents and Settings\ba-test\test\conf\killall.bat " 
echo --------------------------------------------
echo KILLING MACHINE: ba-test@kb-test-bar-011.bitarkiv.kb.dk
ssh ba-test@kb-test-bar-011.bitarkiv.kb.dk "cmd /c  c:\Documents and Settings\ba-test\test\conf\killall.bat " 
echo --------------------------------------------
