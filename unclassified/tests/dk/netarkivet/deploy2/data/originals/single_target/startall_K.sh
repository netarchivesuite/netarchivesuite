...
ssh dev@kb-test-bar-010.bitarkiv.kb.dk "cmd /c  c:\Documents and Settings\dev\TEST\conf\startall.bat " 
echo --------------------------------------------
echo STARTING MACHINE: dev@kb-test-bar-011.bitarkiv.kb.dk
ssh dev@kb-test-bar-011.bitarkiv.kb.dk "cmd /c  c:\Documents and Settings\dev\TEST\conf\startall.bat " 
echo --------------------------------------------
echo STARTING MACHINE: dev@kb-test-bar-012.bitarkiv.kb.dk
ssh dev@kb-test-bar-012.bitarkiv.kb.dk "cmd /c  c:\Documents and Settings\dev\TEST\conf\startall.bat " 
echo --------------------------------------------
echo STARTING MACHINE: dev@kb-test-bar-013.bitarkiv.kb.dk
ssh dev@kb-test-bar-013.bitarkiv.kb.dk "cmd /c  c:\Documents and Settings\dev\TEST\conf\startall.bat " 
echo --------------------------------------------
echo STARTING MACHINE: dev@kb-test-bar-014.bitarkiv.kb.dk
ssh dev@kb-test-bar-014.bitarkiv.kb.dk "cmd /c  c:\Documents and Settings\dev\TEST\conf\startall.bat " 
echo --------------------------------------------
