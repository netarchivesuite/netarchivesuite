...
public class BatchGUITester {
    ...
    // TODO fix the problem with the 'MockHttpServletRequest', where the
    // elements
    ...
    //
    // PageContext context = new WebinterfaceTestCase.TestPageContext(request,
    // out, l);
    //
    ...
    //
    // assertTrue("Should contain the name of the batchjob, '" +
    // ChecksumJob.class.getName()
    // + "', but was: \n" + content,
