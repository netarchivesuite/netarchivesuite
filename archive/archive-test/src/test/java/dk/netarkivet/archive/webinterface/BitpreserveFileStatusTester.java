...
public class BitpreserveFileStatusTester {
    ...
    private static final String ADD_COMMAND = dk.netarkivet.archive.webinterface.Constants.ADD_COMMAND;
    private static final String GET_INFO_COMMAND = dk.netarkivet.archive.webinterface.Constants.GET_INFO_COMMAND;
    private static final String BITARCHIVE_NAME_PARAM = dk.netarkivet.archive.webinterface.Constants.BITARCHIVE_NAME_PARAM;
    ...
    public void testUpdateRequest() throws NoSuchFieldException, IllegalAccessException {
        ...
        // request.setupAddParameter(dk.netarkivet.archive.webinterface.Constants.UPDATE_TYPE_PARAM,
        // new
        // String[]{dk.netarkivet.archive.webinterface.Constants.CHECKSUM_OPTION});
        //
    ...
    public void testProcessChecksumRequest() throws NoSuchFieldException, IllegalAccessException {
        ...
        PageContext context = dk.netarkivet.common.webinterface.WebinterfaceTestCase.getDummyPageContext(l, request);
    ...
    // FIXME: MOCK
    class MockFileBasedActiveBitPreservation extends FileBasedActiveBitPreservation {
        public Map<String, List<String>> calls = new HashMap<String, List<String>>();

        public MockFileBasedActiveBitPreservation() throws NoSuchFieldException, IllegalAccessException {
            Field f = ReflectUtils.getPrivateField(FileBasedActiveBitPreservation.class, "instance");
            f.set(null, this);
        }
        ...
        public void addCall(Map<String, List<String>> map, String key, String args) {
        ...
        public void uploadMissingFiles(Replica replica, String... filename) {
            addCall(calls, ADD_METHOD, filename[0] + "," + replica.getId());
        }
        ...
        public Map<String, PreservationState> getPreservationStateMap(String... filenames) {
            Map<String, PreservationState> result = new HashMap<String, PreservationState>();
