...
public interface ActiveBitPreservation {
    ...
    /**
     * Get details of the state of one or more files in the bitarchives and
     * admin data.
     * 
     * @param filenames
     *            the list of filenames to investigate
     * @return a map ([filename]-> [FilePreservationState]) with the
     *         preservationstate of all files in the list. The
     *         preservationstates in the map will be null for all filenames,
    ...
    /**
     * Return a list of files marked as missing on this replica. A file is
     * considered missing if it exists in admin data, but is not known in the
     * bit archives. Guaranteed not to recheck the archive, simply returns the
    ...
    /**
     * Return a list of files with changed checksums on this replica. A file is
     * considered changed if checksum does not compare to admin data. Guaranteed
     * not to recheck the archive, simply returns the list generated by the last
     * test.
     *
     * @param replica
    ...
    /**
     * Update the list of files in a given bitarchive. This will be used for the
     * next call to getMissingFiles.
     *
     * @param replica
     *            The replica to update list of files for.
     */
    void findMissingFiles(Replica replica);

    /**
     * Update the list of checksums in a given replica. This will be used for
     * the next call to getChangedFiles.
     *
     * @param replica
     *            The replica to update list of files for.
     */
    ...
    /**
     * Return the number of missing files for replica. Guaranteed not to recheck
     * the archive, simply returns the number generated by the last test.
     *
     * @param replica
    ...
    /**
     * Return the number of changed files for replica. Guaranteed not to recheck
     * the archive, simply returns the number generated by the last test.
     *
     * @param replica
    ...
    /**
     * Return the total number of files for replica. Guaranteed not to recheck
     * the archive, simply returns the number generated by the last update.
     *
     * @param replica
     ...
     * not to recheck the archive, simply returns the date for the last test.
     *
     * @param replica
    ...
    /**
     * Check that files are indeed missing on the given replica, and present in
