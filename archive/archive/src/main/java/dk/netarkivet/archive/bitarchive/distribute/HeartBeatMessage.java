 ...
 * A heartbeat has an applicationId, that identifies the application that
 * generated the heartbeat.
 *
 * TODO This class should probably contain more status data from bit archive
 * application later.
 *
 */
...
public class HeartBeatMessage extends ArchiveMessage {
    ...
    /**
     * Creates a heartbeat message. The time of the heartbeat is set to the
     * creation of this object.
     *
     * @param inReceiver
     *            ChannelID for the recipient of this message.
     * @param applicationId
     *            - id of the application that sent the heartbeat
     */
