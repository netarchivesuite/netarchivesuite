...
public class FileBasedActiveBitPreservation
     ...
     * stored in the file list output area (WorkFiles.FILES_ON_BA).
     *
     ...
     * specified by WorkFiles.FILES_ON_BA or WorkFiles.FILES_ON_REFERENCE_BA.
     *
     * @param location       the location where the given bitarchive lies
     * @param referencedBy   The location that we are in the process of doing
     *                       bit preservation for. This determines where output
     *                       is placed.
    ...
    public void runFileListJob(Location location, Location referencedBy,
        ...
        if (referencedBy != null) {
            batchOutputFile =
                    WorkFiles.getFile(referencedBy,
                                      WorkFiles.FILES_ON_REFERENCE_BA);
        } else {
            batchOutputFile = WorkFiles.getFile(location,
