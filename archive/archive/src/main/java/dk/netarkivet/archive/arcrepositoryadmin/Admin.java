...
/**
 * The interface for the administration of the storage. This can be either a
 * data file or a database.
 */
public interface Admin {
    ...
    /**
     * Sets the checksum of a given file. TODO Should it really be possible to
     * change the checksum through arcrepository?
     * 
     * @param filename
     ...
     *             voting through the bitpreservation interface should it be
     *             possible.
     */
     ...
     *            The name of the identification channel for the replica of for
    ...
    /**
     * Determines whether a given file in a specific replica has a valid store
     * state.
     * 
     * @param filename
     *            The name of the file for the ReplicaStoreState.
