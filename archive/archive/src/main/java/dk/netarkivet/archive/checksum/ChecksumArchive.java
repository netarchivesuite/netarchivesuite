...
public interface ChecksumArchive {
    ...
    /**
     * Method for removing a bad entry from the archive. This finds the record
     * and removes it if it has the incorrect checksum. The incorrect record is
     * not deleted, but instead put into a backup file for all the incorrect
     * records.
     * 
     * @param filename
     *            The name of the file whose record should be removed.
     * @param correctFile
     *            The correct remote file to replace the bad one in the archive.
     ...
     *             a different checksum than expected.
     */
    ...
    /**
     * Method for uploading a new file to the archive. The checksum of the file
     * needs to be calculated before it is placed in the archive with the given
     * filename.
     * 
     * @param arcfile
     *            The remote file to be uploaded.
     * @param filename
    ...
    /**
     * Method for calculating the checksum when the file is received in the form
     * of an inputstream.
     * 
     * @param is
