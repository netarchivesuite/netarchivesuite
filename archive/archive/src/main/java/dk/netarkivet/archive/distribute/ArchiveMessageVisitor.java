 ...
 * the ArchiveMessageHandler.onMessage() method invokes the
 * ArchiveMessage.accept() method on the message with itself as argument. The
 * accept() method in turn invokes the ArchiveMessageVisitor.visit() method,
