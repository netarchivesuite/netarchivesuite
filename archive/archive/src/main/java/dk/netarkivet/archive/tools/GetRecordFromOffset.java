/* File:        $Id: GetRecord.java 2251 2012-02-08 13:03:03Z mss $
...
public class GetRecordFromOffset extends ToolRunnerBase {
     ...
     *
     * @param argv Takes two command line paramers: - filename, offset
     */
    public static void main(String[] argv) {
        GetRecordFromOffset instance = new GetRecordFromOffset();
    ...
    private static class GetRecordTool implements SimpleCmdlineTool {
        ...
        public void run(String... args) {
            try {
                ...
                BitarchiveRecord rec = arcrep.get(filename, offset);
