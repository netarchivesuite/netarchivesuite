...
public class ArchiveSettings {
     ...
     * Absolute/relative path to where the "central list of files and checksums"
     * (admin.data) is written. Used by ArcRepository and BitPreservation.
     */
     ...
     * than this, the bitarchive machine stops listening for uploads. This value
     * should at the very least be greater than the largest ARC file you expect
     * to receive.
     */
     ...
     * These are the directories where ARC files are stored (in a subdir). If
     * more than one is given, they are used from one end. This setting may be
     * repeated, to define multiple directories. Note: This value should always
     * be so much lower than minSpaceRequired, that the difference matches at
     * least the size of files we expect to receive.
     */
     ...
     * If we haven't heard from a bit archive within this many milliseconds, we
     * don't expect it to be online and won't wait for them to reply on a batch
     * job. This number should be significantly greater than heartbeatFrequency
     * to account for temporary network congestion.
     */
     ...
     * Credentials to enter in the GUI for "deleting" ARC files in this bit
     * archive.
     */
     ...
     * ReplicaCacheDatabase class. It has the default value: 'jdbc:derby'. Do
     * not retrieve this directly, use in stead the function
     ...
     * ReplicaCacheDatabase class. It is default: 'localhost'. If this is empty,
     * then it will be ignored. Do not retrieve this directly, use in stead the
     * function
     * dk.netarkivet.archive.arcrepositoryadmin.DBConnect.getArchiveUrl().
     */
     ...
     * ReplicaCacheDatabase class. It is default: '1527'. If this is empty, then
     * it will be ignored. Do not retrieve this directly, use in stead the
     * function
     * dk.netarkivet.archive.arcrepositoryadmin.DBConnect.getArchiveUrl().
     */
     ...
     * Setting for giving the machine of the external database used by the
     * ReplicaCacheDatabase class. It is default: 'admindb'. If this is empty,
     * then it will be ignored. Do not retrieve this directly, use in stead the
     * function
     * dk.netarkivet.archive.arcrepositoryadmin.DBConnect.getArchiveUrl().
     */
     ...
     * 
     * @see <a
     *      href="http://www.mchange.com/projects/c3p0/index.html#maxStatements">
     ...
     * 
     * @see <a
     *      href="http://www.mchange.com/projects/c3p0/index.html#maxStatementsPerConnection">
     ...
     * 
     * @see <a
     *      href="http://www.mchange.com/projects/c3p0/index.html#idleConnectionTestPeriod">
     ...
     * 
     * @see <a
     *      href="http://www.mchange.com/projects/c3p0/index.html#testConnectionOnCheckin">
     ...
     * 
     * @see <a
     *      href="http://www.mchange.com/projects/c3p0/index.html#preferredTestQuery">
    ...
    /**
     * <b>settings.archive.checksum.class</b> This decides how to store the
     * checksums, in file, og BDB database. By default, it is stored in a file
     */
