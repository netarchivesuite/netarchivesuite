...
public class JMXProxy extends ToolRunnerBase {
    ...
    protected SimpleCmdlineTool makeMyTool() {
        return new SimpleCmdlineTool() {
            ...
            /**
             * Run the tool. Simply forward all logging mbeans to the local mbean server. Then waits.
             *
             * @param args Not used.
             */
            ...
            /**
             * Describes the parameters that this tool accepts. One argument is needed: The query, e.g
