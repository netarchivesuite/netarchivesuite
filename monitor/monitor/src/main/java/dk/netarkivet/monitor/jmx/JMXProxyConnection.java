...
/**
 * JMX interface for connection objects that can be used for accessing MBeans on
 * remote servers. Connection method and policies are implementation-dependent.
 */
public interface JMXProxyConnection {
    /**
     * Method to create a proxy to a given MBean on some remote server. Example
     * use:
     *
     ...
     *
     * @param name
     *            The name of an MBean on some remote server.
     * @param intf
    ...
    /**
     * Get the set of ObjectNames from the remote MBeanserver, that matches the
     * given query.
     * 
     * @param query
     *            the given query
