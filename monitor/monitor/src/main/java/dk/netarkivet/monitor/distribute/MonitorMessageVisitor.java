 ...
 * the MonitorMessageHandler.onMessage() method invokes the
 * MonitorMessage.accept() method on the message with itself as argument. The
 * accept() method in turn invokes the MonitorMessageVisitor.visit() method,
