...
public abstract class CrawlDataIterator {
     ...
     * 
     * @param source
     *            The location of the crawl data. The meaning of this value may
     *            vary based on the implementation of concrete subclasses.
     *            Typically it will refer to a directory or a file.
     */
