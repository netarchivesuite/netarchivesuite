...
public abstract class ArchiveBatchJobBase extends FileBatchJob {
     ...
     *            the given exception
     * @param archiveFile
     *            The archive file where the exception occurred.
     * @param index
     *            The offset in the archive file where the exception occurred.
     */
     ...
     * Actually use the archive file/index entries in the exception list
     *
     * @param e
     *            An Exception thrown by the org.archive.io.arc classes.
     * @param archiveFile
     *            The archive file that was processed while the Exception was
     *            thrown
     * @param index
     *            The index (in the archive file) at which the Exception was
     *            thrown
     ...
     * archive batch job. If called by a subclass, a method overriding
     * handleException() should always call super.handleException().
     *
