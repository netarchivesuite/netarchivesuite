 ...
 * Constants-class in that package, and make sure it is package private
 * (no modifiers).
 *
 * If your constant is used in a single class only, put it in that class,
 * and make sure it is private
 *
...
public class Constants {
    ...
    /** The suffic of a regexp that matches the metadata files.  Add
