...
/**
 * This exception indicates that we have forwarded to a JSP error page and thus
 * should stop all processing and just return at the top level JSP.
 */
...
public class ForwardedToErrorPage extends NetarkivetException {
     ...
     *            Explanatory message
     * @param cause
     *            The exception that prompted the forwarding.
     */
