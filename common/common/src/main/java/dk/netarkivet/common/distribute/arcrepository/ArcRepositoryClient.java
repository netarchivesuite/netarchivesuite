...
public interface ArcRepositoryClient extends HarvesterArcRepositoryClient, ViewerArcRepositoryClient,
     ...
     *             if the given arcfile is null or empty string, or the given
     *             index is negative.
     */
     ...
     * @param replica
     *            The bitarchive to retrieve the data from. On implementations
     *            with only one replica, null may be used.
     * @param toFile
