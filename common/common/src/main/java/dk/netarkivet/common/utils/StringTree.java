...
/**
 * An interface defining a structure with nodes, subnodes and leaves. This is a
 * recursively defined datastructure, so each instance can be a tree or a leaf.
 * Each is node is named with a String, and each leaf can contain a value of
 * type T. Each non-leaf tree can have any number of subnodes, each identified
 * by a String.
 * 
 * @param <T>
 *            The leaf type
...
public interface StringTree<T> {
     ...
     * @throws IllegalState
     *             if this object is a leaf or if there is not exactly one
     ...
     * @throws IllegalState
     *             if this object is a leaf or if there is more than one subtree
     *             with the same name.
     */
     ...
     * @throws IllegalState
     *             if this object is a leaf or if any of its children are not
     *             leaves.
     */
