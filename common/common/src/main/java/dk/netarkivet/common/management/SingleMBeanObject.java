 ...
 * 
 * @param <I>
 *            The Type of Object to expose as an MBean. Currently only used with
 *            {@link SingleMBeanObject}
 */
public class SingleMBeanObject<I> {
     ...
     *            The object to expose as an MBean.
     * @param asInterface
     *            The interface this MBean is exposed as.
     * @param mBeanServer
     *            The server to register the mbean in.
     *
     * @throws ArgumentNotValid
     *             If domain is null or empty, or any other argument is null.
     */
     ...
     *
     * @param name
     *            The object name to register under.
     * @param o
     *            The object to register.
     * @param asInterface
     *            The interface o should implement.
     * @param mBeanServer
     *            The mbean server to register o in.
     *
     * @throws ArgumentNotValid
     *             on any null parameter.
     */
