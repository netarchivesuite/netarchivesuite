...
public final class DomainUtils {
    ...
    /**
     * A regular expression matching hostnames, and remembering the hostname in
     * group 1 and the domain in group 2.
     */
    ...
    /**
     * Helper method for reading TLDs from settings. Will read all settings,
     * validate them as legal TLDs and warn and ignore them if any are invalid.
     ...
     * 
     * @param domainName
     *            A name of a domain (netarkivet.dk)
    ...
    /**
     * Return a domain name. A domain name is defined as either an IP address if
     * the given host is an IP address, or a postfix of the given host name
     * containing one hostnamepart and a TLD as defined in settings.
     *
     ...
     *
     * @param hostname
     *            A hostname or IP address. Null hostname is not allowed
     * @return A domain name (foo.bar) or IP address, or null if no valid domain
     *         could be obtained from the given hostname. If non-null, the
     *         return value is guaranteed to be a valid domain as determined by
     *         isValidDomainName().
     */
