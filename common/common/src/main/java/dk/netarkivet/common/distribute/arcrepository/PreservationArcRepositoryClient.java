...
public interface PreservationArcRepositoryClient {
     ...
     * @param replicaId
     *            The replica id from which to remove the file.
     * @param checksum
     ...
     * 
     * @param replicaId
     *            The name of the replica to send the message.
     * @param filename
     *            The name of the file for whom the checksum should be
     *            retrieved.
     * @return The checksum of the file in the replica. Or null if an error
     *         occurred.
     */
     ...
     * 
     * @param replicaId
     *            The identification of the replica.
     * @param checksum
     ...
     * @param credentials
     *            The password for allowing to remove a file entry in the
     *            archive.
