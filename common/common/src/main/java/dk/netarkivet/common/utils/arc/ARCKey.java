...
public class ARCKey {
    ...
    /**
     * Constructor for ARCKey. Note that if the filename ends in .dat (it's an
     * Alexa-style DAT file), we assume that the file we actually want is a
     * .arc.gz file as produced by Alexa tools. That is because the Alexa cdx
     * generator does not put the correct filename in there.
     *
     * @param archiveFileName
     *            The name of the archive found in the cdx file
     * @param offset
     *            The offset in the arc file of this entry.
     */
