 ...
 * addition steps, giving users of <code>ComponentLifeCycle</code> better
 * control over the component startup and shutdown phases.
 */
public interface ComponentLifeCycle {

    /**
     * Implements functionality for starting an instances of this
     * <code>ComponentLifeCycle</code> object. This may be loading files,
     * establish connections, initializing data, starting threads, etc.
     */
    void start();
