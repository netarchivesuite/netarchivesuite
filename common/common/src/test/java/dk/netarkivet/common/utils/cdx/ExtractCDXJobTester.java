...
public class ExtractCDXJobTester extends TestCase {
    //Shared File for cdx output:
    private File cdxFile;
    //Shared instance of BatchLocalARCFiles
    ...
    protected void setUp() throws Exception {
        super.setUp();
        processed = 0;
        blaf = new BatchLocalFiles(new File[]{TestInfo.ARC_FILE1,
    ...
    /**
     * Verify that construction succeeds regardless of the paramters.
     */
