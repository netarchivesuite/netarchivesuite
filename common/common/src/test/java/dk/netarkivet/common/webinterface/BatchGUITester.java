...
public class BatchGUITester extends TestCase {
    MoveTestFiles mtf = new MoveTestFiles(Constants.ORIGINALS_DIR, Constants.WORKING_DIR);
    ...
    public void setUp() {
        ...
        Settings.set(CommonSettings.BATCHJOBS_BASEDIR, Constants.BATCH_DIR.getAbsolutePath());
    }
