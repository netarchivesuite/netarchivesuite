...
public class TrivialArcRepositoryClient implements ArcRepositoryClient {
    ...
    /**
     * Constructor for this class. Creates a local directory for the
     * arcrepository.
     */
     ...
     * @param replica
     *            The bitarchive to retrieve the data from (not used in this
     *            implementation)
     * @param toFile
     ...
     *
     * @param replicaId
     *            The archive to execute the job on (not used in this
     *            implementation)
     * @param args
     ...
     * this checksum matches that of the underlying files.
     *
     * @param filename
     *            The name of a file stored in the ArcRepository.
     * @param checksum
     ...
     * @param checksum
     *            The checksum of the file to be removed (not used)
     * @param credentials
