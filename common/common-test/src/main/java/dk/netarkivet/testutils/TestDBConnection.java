...
public class TestDBConnection implements Connection {
     ...
     *
     * @exception SQLException if a database access error occurs or this <code>Connection</code> object is in
     *                auto-commit mode
     * @see #setAutoCommit
     */
     ...
     * @exception SQLException if a database access error occurs or this method is called during a transaction
     */
     ...
     * @exception SQLException if a database access error occurs or the given parameter is not one of the
     ...
     *         and concurrency
     * @exception SQLException if a database access error occurs or the given parameters are not <code>ResultSet</code>
     ...
     * @exception SQLException if a database access error occurs, the <code>Savepoint</code> object is no longer valid,
     ...
     * @exception SQLException if a database access error occurs or the given <code>Savepoint</code> object is not a
     ...
     * @exception SQLException if a database access error occurs or the given parameter is not a <code>Statement</code>
