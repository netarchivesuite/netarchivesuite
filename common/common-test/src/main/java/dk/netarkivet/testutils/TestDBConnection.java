 ...
 *
 * 1) Commits are blithely ignored 2) prepareStatement calls keep their string
 * available
 *
 */
public class TestDBConnection implements Connection {
     ...
     *
     * In the TestDBConnection 'implementation', commit is ignored, but the
     * savepoints are still forgotten locally -- we will still be able to roll
     * back the entire test.
     *
     * @exception SQLException
