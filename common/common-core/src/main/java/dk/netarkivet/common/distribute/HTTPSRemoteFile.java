...
/**
 * A remote file implemented with point-to-point HTTPS communication. Optimised to communicate locally, if file is on
 * the same host. Optimised to transfer 0 byte files inline. Will use one shared certificate for secure communication.
 */
...
public class HTTPSRemoteFile extends HTTPRemoteFile {
     ...
     * The setting for the password that the keystore used for HTTPS remotefile keystore is encrypted with. Refer to the
     * configuration manual for how to build a keystore.
     */
