 ...
 * <p>
 * [ARCHIVEFILE] [Opened] [Closed] [Size] 5-1-20100720161253-00000-bnf_test.arc.gz "2010-07-20 16:12:53.698"
 * "2010-07-20 16:14:31.792" 162928
 * <p>
 * The file is named "archivefiles-report.txt" and is generated by parsing the "heritrix.out" file located in the crawl
 * directory. Useful lines match the following examples:
 * <p>
 * 2010-07-20 16:12:53.698 INFO thread-14 org.archive.io.WriterPoolMember.createFile() Opened
 * /somepath/jobs/current/high/5_1279642368951/arcs/5-1-20100720161253-00000.arc.gz.open
 * <p>
 * and
 * <p>
 * 2010-07-20 16:14:31.792 INFO thread-29 org.archive.io.WriterPoolMember.close() Closed
 * /somepath/jobs/current/high/5_1279642368951/arcs/5-1-20100720161253-00000-bnf_test.arc.gz, size 162928
 * <p>
 * In order to have such messages output to heritrix.out, the "heritrix.properties" file must contain the following,
 * uncommented line:
 * <p>
 * org.archive.io.arc.ARCWriter.level = INFO
 * <p>
 * Note that these strings have changed between Heritrix version 1.14.3 and 1.14.4, so they might change again in the
 * future.
 */
class ArchiveFilesReportGenerator {
    ...
    /**
     * Parses the heritrix.out file and maps to every found ARC file an {@link ArchiveFileStatus} instance.
     *
