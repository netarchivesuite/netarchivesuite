...
//
//
// This should be added to the heritrix script used by NAS
//
//http://kris-sigur.blogspot.dk/2014/10/heritrix-java-8-and-sunsecuritytoolskey.html


public class H3Launcher extends HeritrixLauncher{
	...
	public void lauchHeritrix(File heritrix3Bundle, File unpackDir, String hostname, int port)  {
