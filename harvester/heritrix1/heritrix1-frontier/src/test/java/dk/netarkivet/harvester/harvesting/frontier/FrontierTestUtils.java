...
final class FrontierTestUtils {
    ...
    public static String toString(FrontierReportLine l) {
        return l.getDomainName() + " " + l.getCurrentSize() + " " + getDisplayValue(l.getTotalEnqueues()) + " "
                + getDisplayValue(l.getSessionBalance()) + " " + getDisplayValue(l.getLastCost()) + "("
                + getDisplayValue(l.getAverageCost()) + ")" + " " + l.getLastDequeueTime() + " " + l.getWakeTime()
                + " " + getDisplayValue(l.getTotalSpend()) + "/" + getDisplayValue(l.getTotalBudget()) + " "
                + getDisplayValue(l.getErrorCount()) + " " + l.getLastPeekUri() + " " + l.getLastQueuedUri();
    }
