...
public class IngestableFilesTester {
    ...
    public void testConstructor() {
        ...
        //HeritrixFiles NotOkFilesWithBadJobId = HeritrixFiles.getH1HeritrixFilesWithDefaultJmxFiles(existingDir, unacceptableJobInfo);
        new IngestableFiles(OkFiles);
    }
    ...
    public void testConstructorWithNonExistingCrawlDir() {
        ...
        HeritrixFiles heritrixFilesNonExistingCrawlDir =
        		HeritrixFiles.getH1HeritrixFilesWithDefaultJmxFiles(new File(WORKING_DIR, "doesnotexist"), acceptableJobInfoForJobOne);
    ...
    public void testConstructorWithBadJobInfo() {
        ...
        HeritrixFiles heritrixFilesWithBadJobInfo = HeritrixFiles.getH1HeritrixFilesWithDefaultJmxFiles(WORKING_DIR, unacceptableJobInfo);
