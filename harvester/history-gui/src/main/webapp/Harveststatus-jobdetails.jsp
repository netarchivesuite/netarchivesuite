...
--%><%@ page import="dk.netarkivet.common.utils.I18n,
                 ...
                 dk.netarkivet.harvester.webinterface.HarvestStatusJobDetails"
         pageEncoding="UTF-8"
%>
...
<%
    ...
    HarvestStatusJobDetails helper = new HarvestStatusJobDetails(response, pageContext, I18N);
    HTMLUtils.generateHeader(pageContext);
    helper.PrintPageContent(out, I18N, response.getLocale());
