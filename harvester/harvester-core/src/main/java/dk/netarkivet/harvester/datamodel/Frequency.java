...
public abstract class Frequency {
     ...
     * integer
     *
     * @return Return an integer that can be used to identify the kind of frequency
     */
    public abstract int ordinal();

    /**
     * Get a new instance of Frequency. The type of Frequency (either Hourly, Daily, Monthly, or Weekly) returned
     * depends on the 'timeunit' argument.
     *
     ...
     * @param dayofweek A given day of the week. Used only to create weekly frequencies, if anytime is false.
