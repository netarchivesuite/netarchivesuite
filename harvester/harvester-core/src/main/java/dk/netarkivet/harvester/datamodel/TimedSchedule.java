...
public class TimedSchedule extends Schedule {
     ...
     * @throws ArgumentNotValid if frequency, name or comments is null, or name is "" or
     */
    ...
    /**
     * Return the date at which the next event will happen. If the calculated next date is exactly equal to the end date
