...
/**
 * Immutable password class. Represents a http credentials password. See RFC 2617: HTTP Authentication: Basic and Digest
...
public final class Password implements Named {
    ...
    /**
     * The realm for this Password. Defines a specific protection space on a webserver. See RFC 2617, section 1.2
     */
