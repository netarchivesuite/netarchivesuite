...
public abstract class CombiningMultiFileBasedCache<T extends Comparable<T>> extends MultiFileBasedCache<T> {
    ...
    /**
     * This is called when an appropriate file for the ids in question has not been found. It is expected to do the
     * actual operations necessary to get the data. At the outset, the file for the given IDs is expected to be not
     * present.
     *
