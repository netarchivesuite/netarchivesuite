...
public enum TimeUnit {
     ...
     * "on hour" will be set, i.e. "on day of week" and "on day of month" are
     * unused.
     **/
    DAILY,
    /**
     * Weekly time unit will result in a frequency where only "on minute",
     * "on hour" and "on day of week" will be set, i.e. "on day of month" is
     * unused.
     **/
    WEEKLY,
    /**
     * Monthly time unit will result in a frequency where only "on minute",
     * "on hour" and "on day of month" will be set, i.e. "on day of week" is
     * unused.
     **/
    MONTHLY,
    /**
     * For minute time units, it doesn't make sense to use any additional
     * constraints: "on minute", "on hour", "on day of month" or
     * "on day of week"
     */
    MINUTE;
     ...
     *             If argument tu is invalid (i.e. does not correspond to a
     *             TimeUnit)
     */
