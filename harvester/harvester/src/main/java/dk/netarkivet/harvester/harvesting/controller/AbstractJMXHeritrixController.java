...
implements HeritrixController {
	...
	private static final Log log = 
		LogFactory.getLog(AbstractJMXHeritrixController.class);
	...
	private final int jmxPort = 
		Settings.getInt(HarvesterSettings.HERITRIX_JMX_PORT);

	/**
	 * The port to use for Heritrix GUI, as set in settings.xml.
	 */
	private final int guiPort = 
		Settings.getInt(HarvesterSettings.HERITRIX_GUI_PORT);
