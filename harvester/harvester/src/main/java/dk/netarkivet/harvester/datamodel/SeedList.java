...
/**
 * Representation of the list of harvesting seeds. Basically just a list of
 * URL's.
 *
 */
...
public class SeedList implements Serializable, Named {
    ...
    /**
     * Create new seedlist. Helper constructor that takes the seeds as a newline
     * separated string.
     * 
     * @param name
     *            the name of the new seedlist
     * @param seedsAsString
     *            the seeds
     * @throws ArgumentNotValid
     *             if name is null or empty or seeds are null. Empty seeds are
     *             allowed.
     */
    ...
    /**
     * Check urls for validity. Valid seeds are controlled by a configurable
     * regular expression
     * 
    ...
    /**
     * Check if this seedlist has an ID set yet (doesn't happen until the DBDAO
     * persists it).
     * 
