...
/**
 * Message sent by a {@link HarvestController} at startup, to check if the
 * channel name it has been assigned is valid (e.g. registered in the harvest
 * database).
 *
 * The message is sent on a dedicated queue, and processed by the
 * {@link HarvestMonitor}, which checks if the channel name matches a channel
