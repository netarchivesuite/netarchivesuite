/* File:        $Id: JobDAO.java 2803 2013-10-29 15:42:35Z ngiraud $
...
implements Iterable<Job> {
     ...
     *                          writing the job
     */
    public abstract void create(final Job job);
     ...
     */
    public abstract boolean exists(final Long jobID);
     ...
     */
    public abstract Job read(final Long jobID)
     ...
     */
    public abstract void update(final Job job) throws IOFailure;
     ...
     */
    public abstract Iterator<Job> getAll(final JobStatus status);
     ...
     *                          valid states specified in JobStatus.
     */
    public abstract Iterator<Long> getAllJobIds(final JobStatus status);
     ...
     */
    public abstract HarvestStatus getStatusInfo(final HarvestStatusQuery query);
     ...
     * @throws IOFailure on trouble in database access
     */
    public abstract List<JobStatusInfo> getStatusInfo(final JobStatus status);
     ...
     */
    public abstract List<Long> getJobIDsForDuplicateReduction(final long jobID)
            throws UnknownID;
     ...
     */
    public abstract long rescheduleJob(final long oldJobID);
     ...
     * @throws UnknownID if no job exists with id jobID
     */
    public abstract JobStatus getJobStatus(final Long jobID);
}
