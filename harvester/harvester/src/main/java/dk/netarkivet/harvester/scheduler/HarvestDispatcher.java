 ...
 *
 * The dispatching of jobs occurs when at least one {@link HarvesterStatusMessage}
...
implements MessageListener, ComponentLifeCycle {
     ...
     * as {@link HarvesterStatusMessage}s have been received, and decrements the
