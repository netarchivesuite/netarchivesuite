...
/**
 * This class defines various frequencies at which things can happen, such as
 * midnight every day, 13:45 the first monday of a month, etc.
 */
public abstract class Frequency {
    ...
    public boolean equals(Object o) {
        ...
        if (isAnytime != frequency.isAnytime)
            return false;
        if (numUnits != frequency.numUnits)
            return false;
     ...
     * 
     * @return Return an integer that can be used to identify the kind of
     *         frequency
     */
     ...
     * 
     * @param timeunit
     *            The type or frequency
     * @param anytime
     *            Allow events to start anytime. If false, the starting point is
     *            described precisely. If true, the starting point will be
     *            immediately.
     * @param numtimeunits
     *            The number of periods between events
     * @param minute
     *            A given minute. Used to create hourly, daily, and monthly
     *            frequencies, if anytime is false.
     * @param hour
     *            A given hour. Used to create hourly, daily, and monthly
     *            frequencies, if anytime is false.
     * @param dayofweek
     *            A given day of the week. Used only to create weekly
     *            frequencies, if anytime is false.
     * @param dayofmonth
     ...
     * @throws ArgumentNotValid
     *             If the given timeunit is illegal, or the values of timeunit
     *             and numtimeunits is negative.
     * @throws NotImplementedException
     *             If we can't yet make a Frequency for a legal timeunit.
     */
    public static Frequency getNewInstance(int timeunit, boolean anytime, int numtimeunits, Integer minute,
        ...
        if (!anytime) {
            ...
            ArgumentNotValid
                    .checkTrue(hour != null || tu.equals(TimeUnit.HOURLY),
        ...
        case WEEKLY:
            if (anytime) {
                ...
                freq = new WeeklyFrequency(numtimeunits, dayofweek, hour, minute);
            }
            break;
        case MONTHLY:
            if (anytime) {
                ...
                freq = new MonthlyFrequency(numtimeunits, dayofmonth, hour, minute);
            }
            break;
        case MINUTE: // Minute frequencies are always "anytime"
            ...
            break;
        default:
            throw new NotImplementedException("We don't know how to make a Frequency for timeunit " + timeunit);
        }
        return freq;
    }
