 ...
 *
 * @param <T>
 *            The cache type, must extend java.lang.Comparable.
 */
public abstract class MultiFileBasedCache<T extends Comparable<T>> extends FileBasedCache<Set<T>> {
     ...
     *            directoriy creating in the cachedir will have this name.
     */
    ...
    /**
     * Get the filename for the file containing the combined data for a set of
     * IDs.
     *
     * @param ids
     *            A set of IDs to generate a filename for
     * @return A filename that uniquely identifies this set of IDs within the
     *         cache. It is considered acceptable to have collisions at a
     *         likelihood the order of 1/2^128 (i.e. use MD5 to abbreviate long
     *         lists).
     */
