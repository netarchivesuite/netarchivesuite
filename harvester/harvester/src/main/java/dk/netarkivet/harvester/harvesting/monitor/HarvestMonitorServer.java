/* File:       $Id: HarvestMonitorServer.java 752 2009-03-05 18:09:21Z svc $
 ...
 */
public class HarvestMonitorServer extends HarvesterMessageHandler
implements MessageListener {
	 ...
	 */
	public static final ChannelID JMS_CHANNEL_ID = 
	...
	public StartedJobInfo[] getAllJobInfos() {
		...
		return (StartedJobInfo[]) infos.toArray(
				new StartedJobInfo[infos.size()]);
	}
