...
public class HistorySiteSection extends SiteSection {
    ...
    public HistorySiteSection() {
        super("sitesection;history", "Harveststatus", 3, new String[][] { { "alljobs", "pagetitle;all.jobs" },
                ...
                { "running", "pagetitle;all.jobs.running" }, { "running-jobdetails", "pagetitle;running.job.details" },
                { "perhd", "pagetitle;all.jobs.per.harvestdefinition" },
                { "perharvestrun", "pagetitle;all.jobs.per.harvestrun" },
                { "jobdetails", "pagetitle;details.for.job" }, { "perdomain", "pagetitle;all.jobs.per.domain" },
                { "seeds", "pagetitle;seeds.for.harvestdefinition" } }, "History",
