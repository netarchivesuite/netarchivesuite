/* File:       $Id: HarvestStatusQuery.java 752 2009-03-05 18:09:21Z svc $
...
public class HarvestStatusQuery {
	...
	/**
	 * Builds a default query that will jobs for a given run of a harvest.
	 */
	...
	public JobStatus[] getSelectedJobStatuses() {
		return (JobStatus[]) jobStatuses.toArray(
				new JobStatus[jobStatuses.size()]);
	}
