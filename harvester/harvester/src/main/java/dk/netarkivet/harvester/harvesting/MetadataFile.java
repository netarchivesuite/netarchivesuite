...
public class MetadataFile implements Comparable<MetadataFile> {
     ...
     *
     * @see dk.netarkivet.archive.indexserver.CrawlLogDataCache
     * #CrawlLogDataCache()
     */
    ...
    /** The url representing the record in metadata-arc-file for this 
     * metadata file. */
    private String url;
     ...
     * @param harvestId The harvestID that the job generating this file 
     * is part of.
