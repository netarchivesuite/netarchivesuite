...
public class MonthlyFrequency extends Frequency {
    ...
    /**
     * Create a new monthly frequency that happens every numUnits month,
     * anytime.
     *
     * @param numUnits
    ...
    /**
     * Create a new monthly frequency that happens every numUnits month, on the
     * given day of month, hour and minute.
     *
     * @param numUnits
     *            Number of days from event to event.
     * @param dayOfMonth
     *            The day of the month the event should happen. The month starts
     *            on day 1.
     * @param hour
     ...
     * @throws ArgumentNotValid
     *             if numUnits if 0 or negative or dayOfMonth <1 or >31 or hour
     *             is <0 or >23 or minutes is <0 or >59
     */
