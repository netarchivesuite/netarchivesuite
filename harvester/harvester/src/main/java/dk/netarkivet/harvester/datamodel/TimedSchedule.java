...
public class TimedSchedule extends Schedule {
     ...
     *
     * @param startDate
     *            The time at which the schedule starts running. This is not
     *            necessarily the time of the first event, but no events will
     *            happen before this. May be null, meaning start any time.
     * @param endDate
     *            The time at which the schedule stops running. No events will
     *            happen after this. May be null, meaning continue forever.
     * @param frequency
     *            How frequently the event should happen.
     * @param comments
    ...
    public boolean equals(Object o) {
        ...
        if (endDate != null ? !endDate.equals(timedSchedule.endDate) : timedSchedule.endDate != null)
            return false;
     ...
     * next date is exactly equal to the end date then that value is returned.
     * If it is after the end date, null is returned.
     *
     * @param lastEvent
     *            The time at which the previous event happened. If this is
     *            null, then the method returns null. Ie once one is after the
     *            last event one is always after the last event.
     * @param numPreviousEvents
     *            How many events have previously happened (ignored).
