/* File:        $Id: GlobalCrawlerTrapListDAO.java 2116 2011-10-21 18:04:53Z svc $
 ...
 *
 */
public abstract class GlobalCrawlerTrapListDAO extends HarvestDatabaseDAO {
     ...
     */
    public abstract long create(final GlobalCrawlerTrapList trapList)
     ...
     * trap list.
     */
    public abstract void delete(final long id) throws UnknownID;
     ...
     */
    public abstract void update(final GlobalCrawlerTrapList trapList)
    throws UnknownID;
     ...
     * the database.
     */
    public abstract GlobalCrawlerTrapList read(final long id) throws UnknownID;
