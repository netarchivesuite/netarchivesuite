...
/**
 * Factory class for instantiating a specific implementation of
 * {@link JobGenerator}. The implementation class is defined by the setting
 * {@link HarvesterSettings#JOBGEN_CLASS} &nbsp;(
 * <em>settings.harvester.scheduler.jobgen.class</em>).
 */
public class JobGeneratorFactory extends SettingsFactory<JobGenerator> {

    /**
     * Returns an instance of the configured {@link JobGenerator} implementation
     * defined by the setting {@link HarvesterSettings#JOBGEN_CLASS}. This class
