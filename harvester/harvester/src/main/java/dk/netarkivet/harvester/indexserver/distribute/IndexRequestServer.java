...
public final class IndexRequestServer extends HarvesterMessageHandler implements CleanupIF, IndexRequestServerInterface {
    ...
    private void doProcessIndexRequestMessage(final IndexRequestMessage irMsg) {
        ...
        try {
            ...
            // Here we need to make sure that we don't accidentally process more
            // than
            ...
            synchronized (checksum.intern()) {
                ...
                if (foundIDs.equals(jobIDs)) {
                    ...
                    log.info("Data for full index w/ {} jobs not available. Only found data for {} jobs - "
                            ...
                            foundIDs.size());
                    // Make sure that the index of the data available is
                    // generated
                    ...
                    // Make a copy of the index available, and give it the name
                    // of
                    ...
                    if (cacheFileCreated.isDirectory()) {
                        ...
                        // copy all files in cacheFileCreated to
                        // cacheFileWanted.
                    ...
                    // TODO This delete-operation commented out, because it is
                    // deemed too dangerous,
                    // as the cachedir represented by cacheFileCreated may still
                    // be used
