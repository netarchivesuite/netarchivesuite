...
public class HarvesterSettings {
     ...
     * If the job generator is {@link FixedDomainConfigurationCountJobGenerator} , then this parameter toggles whether
     * or not domain configurations with a budget of zero (byte or objects) should be excluded from jobs. The default
     * value is 'false'.
     */
    ...
    /**
     * <b>settings.harvester.harvesting. continuationFromHeritrixRecoverlogEnabled</b>:</br> Setting for whether or not
     * a restarted job should try fetching the recoverlog of the previous failed job, and ask Heritrix to continue from
