...
public class HarvesterSettings {
    ...
    /**
     * <b>settings.harvester.scheduler.errorFactorBestGuess</b>: <br>
     * Used when calculating expected size of a harvest of some configuration
     * during job-creation process.
     * This defines how great a possible factor we will permit a harvest to
    ...
    /** 
     * <b>settings.harvester.scheduler.maxDomainSize</b>: <br>
    ...
    /**
     * <b>settings.harvester.scheduler.jobs.maxTotalSize</b>: <br>
    ...
    /**
     * <b>settings.harvester.scheduler.configChunkSize</b>: <br>
    ...
    /** 
     * <b>settings.harvester.harvesting.queuePriority</b>: <br>
     ...
     * probably be fairly large. It can be specified in the same way as for 
