...
/**
 * A cache of crawl log indices appropriate for the Icelandic deduplicator code,
 * excluding all text entries.
 *
...
public class DedupCrawlLogIndexCache extends CrawlLogIndexCache {
    ...
    /**
     * Constructor. Calls the constructor of the inherited class with the
     * correct values.
     */
