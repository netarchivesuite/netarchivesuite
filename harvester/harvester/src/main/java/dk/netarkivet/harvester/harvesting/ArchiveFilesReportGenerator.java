 ...
 *
 * [(W)ARCFILE] [Opened] [Closed] [Size]
 *  5-1-20100720161253-00000-bnf_test.arc.gz "2010-07-20 16:12:53.698" "2010-07-20 16:14:31.792" 162928
 *
 * The file is named "(w)arcfiles-report.txt" and is generated by parsing the
...
class ArchiveFilesReportGenerator {
     ...
     */
    public static final String REPORT_FILE_NAME = ARCHIVE_FORMAT + "files-report.txt";
    ...
    protected File generateReport() {
        ...
        try {
            ...
            out.println("[" + ARCHIVE_FORMAT.toUpperCase() + "FILE] [Opened] [Closed] [Size]");
