...
/**
 * This class generate a report that lists ARC/WARC files (depending on the
 * configured archive format) along with the opening date, closing date (if file
 * was properly closed), and size in bytes.
 *
 * Here is a sample of such a file:
 *
 * [ARCHIVEFILE] [Opened] [Closed] [Size]
 * 5-1-20100720161253-00000-bnf_test.arc.gz "2010-07-20 16:12:53.698"
 ...
 * following examples:
 *
 * 2010-07-20 16:12:53.698 INFO thread-14
 * org.archive.io.WriterPoolMember.createFile() Opened
 * /somepath/jobs/current/high
 * /5_1279642368951/arcs/5-1-20100720161253-00000.arc.gz.open
 *
 * and
 *
 * 2010-07-20 16:14:31.792 INFO thread-29
 * org.archive.io.WriterPoolMember.close() Closed
 * /somepath/jobs/current/high/5_1279642368951
 * /arcs/5-1-20100720161253-00000-bnf_test.arc.gz, size 162928
 *
 * In order to have such messages output to heritrix.out, the
 * "heritrix.properties" file must contain the following, uncommented line:
 *
 * org.archive.io.arc.ARCWriter.level = INFO
 *
 * Note that these strings have changed between Heritrix version 1.14.3 and
 * 1.14.4, so they might change again in the future.
 *
 */
