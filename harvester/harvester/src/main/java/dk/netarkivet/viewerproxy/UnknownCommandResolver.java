...
/**
 * Wrapper for an URIResolver, which gives failures on specific specific URLs,
 * and forwards all others to the wrapped handler. This allows you to reserve a
 * specific host for commands and get a well-defined error if giving an
 * undefined command.
 *
 */
public class UnknownCommandResolver extends CommandResolver {
    ...
    /**
     * Helper method that checks if this is a command URL and throw an error if
     * it is.
     *
     * @param request
