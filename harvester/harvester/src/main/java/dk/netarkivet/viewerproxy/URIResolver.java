...
public interface URIResolver {
     ...
     *         cannot be resolved. If HTTP response is returned it should ALWAYS
     *         be the same code as the code set in the response object. if
     *         NOT_FOUND is returned, the response object should contain a
     *         proper error page.
     */
