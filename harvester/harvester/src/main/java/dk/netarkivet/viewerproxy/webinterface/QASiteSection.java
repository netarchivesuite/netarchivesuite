...
public class QASiteSection extends SiteSection {
    ...
    public QASiteSection() {
        super("sitesection;qa", "QA", PAGES_VISIBLE_IN_MENU, new String[][] {
                ...
                { "searchcrawllog", "pagetitle;qa.crawllog.lines.matching.regexp" } }, "QA",
     ...
     *
     * The current implementation is hokey, but trying to go through URL objects
     * is a mess.
     *
     * @param request
     *            The request that we have been called with.
     * @return A URL object that leads to the QA-status page on the same machine
     *         as the request came from.
     */
