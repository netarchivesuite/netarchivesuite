...
public class HarvestDBConnectionTester extends DataModelTestCase {
    ...
    public void testSetStringMaxLength() throws SQLException {
        ...
        try {
            ...
            // Verify, that setStringMaxLength works without warnings, if
            // contents.length() <= maxSize
            ...
            // Verify, that setClobMaxLength issues a warning, if
            // contents.length() > maxSize
            // and that storedContents equals to the first maxSize characters of
            // variable 'contents'
            id = 2;
    ...
    public void testSetClobMaxLength() throws SQLException {
        ...
        try {
            ...
            // Verify, that setClobMaxLength works without warnings, if
            // contents.length() <= maxSize
            // and that storedContents equals to variable 'contents'
    ...
    private void dropTestTable() throws SQLException {
        // drop table "HarvestDBConnectionTester" used for testing set*Max
        // methods
        Connection c = HarvestDBConnection.get();
        try {
