...
public class HangingListenerTest {
    ...
    public void testNotListeningWhileProcessingSunMQ() throws InterruptedException, JMSException {
        // if
        // (!Settings.get(CommonSettings.JMS_BROKER_CLASS).equals(JMSConnectionSunMQ.class.getName()))
        // {
        ...
        // NetarkivetMessage msg = new BatchMessage(theQueue, new ChecksumJob(),
        // "ONE");
        // con.send(msg);
        // }
        // while(HangingListenerTest.messages_received.get() < messagesSent) {}
        // Thread.sleep(2*blockingTime);
        // assertEquals("Blocking listener should only have been called once",
        // 1, blocker.called);
        ...
        // while(HangingListenerTest.messages_received.get() < messagesSent) {}
        // Thread.sleep(2*blockingTime);
        // assertEquals("Blocking listener should now have been called twice",
        // 2, blocker.called);
        // con.cleanup();
        // con2.cleanup();
    }
