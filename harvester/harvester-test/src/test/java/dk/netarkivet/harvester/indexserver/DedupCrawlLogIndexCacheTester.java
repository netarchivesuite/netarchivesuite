...
public class DedupCrawlLogIndexCacheTester extends CacheTestCase {
    ...
    public void testCombine() throws Exception {
        ...
        // new
        // WhitespaceAnalyzer(dk.netarkivet.common.constants.LUCENE_VERSION));
        // QueryParser queryParser = new
        // QueryParser(dk.netarkivet.common.Constants.LUCENE_VERSION, "url",
        // new
        // WhitespaceAnalyzer(dk.netarkivet.common.Constants.LUCENE_VERSION));
        ...
        for (String urlValue : urls) {
            ...
            for (ScoreDoc hit : hits) {
                ...
                if (removedValue == null) {
                    ...
                    // "' not found in origins map");
                } else {
                    // System.out.println("'" + url +
                    // "' was found in origins map");
                }
            }
        }
    }
