...
public class ScheduleDefinitionTester extends HarvesterWebinterfaceTestCase {
    ...
    public void setUp() throws Exception {
        ...
        Schedule schedule1 = new RepeatingSchedule(start, 10, new DailyFrequency(1, 23, 0), "schedule1", "");
    ...
    public void testProcessRequestUpdateSchedule() throws ParseException {
        ...
        assertTrue("Schedule should now be weekly", schedule_updated.getFrequency() instanceof WeeklyFrequency);
        assertEquals("", schedule_updated.getStartDate(), (new SimpleDateFormat(DATE_FORMAT)).parse(startDateString));
    ...
    public void testProcessRequestNewScheduleHourly() {
        ...
        assertTrue("Frequency should be hourly", schedule_updated.getFrequency() instanceof HourlyFrequency);
    ...
    public void testProcessRequestNewDailySchedule() throws ParseException {
        ...
        assertTrue("Should be a Daily Frequency", freq instanceof DailyFrequency);
    ...
    public void testProcessRequestNewWeeklySchedule() throws ParseException {
        ...
        Frequency freq = schedule_updated.getFrequency();
        assertTrue("Should be a weekly Frequency", freq instanceof WeeklyFrequency);
    ...
    public void testProcessRequestNewMonthlySchedule() throws ParseException {
        ...
        Frequency freq = schedule_updated.getFrequency();
        assertTrue("Should be a monthly Frequency", freq instanceof MonthlyFrequency);
