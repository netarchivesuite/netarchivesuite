...
public class WeeklyFrequencyTester {
    ...
    public void testGetFirstEvent1() throws Exception {
        WeeklyFrequency freq = new WeeklyFrequency(4); // Every four days,
                                                       // anytime
    ...
    public void testGetFirstEvent2() throws Exception {
        WeeklyFrequency freq = new WeeklyFrequency(4, Calendar.WEDNESDAY, 4, 22); // Every
                                                                                  // four
                                                                                  // weeks,
                                                                                  // on
                                                                                  // the
    ...
    public void testGetNextEvent2() throws Exception {
        WeeklyFrequency freq = new WeeklyFrequency(4, Calendar.MONDAY, 5, 23); // Every
                                                                               // four
                                                                               // days,
                                                                               // on
                                                                               // the
    ...
    public void testGetNextEvent3() throws Exception {
        WeeklyFrequency freq = new WeeklyFrequency(4, Calendar.MONDAY, 5, 23); // Every
                                                                               ...
                                                                               // and
                                                                               // minute
        Calendar cal = new GregorianCalendar(2005, Calendar.FEBRUARY, 28, 5, 23); // 28/2
                                                                                  // 2005
                                                                                  // is
                                                                                  // a
                                                                                  // Monday
